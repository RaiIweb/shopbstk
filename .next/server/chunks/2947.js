...
;// CONCATENATED MODULE: ./src/framework/rest/utils/use-layout.tsx
...
/* harmony default export */ const use_layout = (useLayout);
...
const Header = () => {
  ...
  return /*#__PURE__*/jsx_runtime_.jsx("header", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      className: external_classnames_default()('flex justify-between items-center w-full h-14 md:h-16 lg:h-22 px-4 lg:px-8 py-5 z-50 fixed bg-light shadow-sm transition-transform duration-300', {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
        ...
        children: [/*#__PURE__*/jsx_runtime_.jsx(static_menu, {}), /*#__PURE__*/jsx_runtime_.jsx("button", {
...
/* harmony import */ var _framework_groups_dropdown_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(920);
...
const SearchBox = _ref => {
  ...
  return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx("form", {
    onSubmit: onSubmit,
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('w-full', className),
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
      className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('rounded md:rounded-md flex items-center relative bg-light px-2 py-1', {
      ...
      children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx("label", {
        ...
        className: "sr-only",
        children: label
      }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx(_framework_groups_dropdown_menu__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z, {
        variant: "minimal"
        ...
        value: value,
        autoComplete: "off",
        className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('w-full h-full flex item-center appearance-none transition duration-300 ease-in-out text-heading text-sm placeholder-gray-500 overflow-hidden rounded-md focus:outline-none focus:ring-0', classes[variant])
      }, rest)), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("button", {
        type: "button",
        onClick: onClearSearch,
        className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('cursor-pointer h-full w-10 md:w-14 flex items-center justify-center text-body transition-colors duration-200 focus:outline-none hover:text-accent-hover focus:text-accent-hover', {
        ...
        }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx(_components_icons_close_icon__WEBPACK_IMPORTED_MODULE_2__/* .CloseIcon */ .T, {
          className: "w-3.5 h-3.5 md:w-3 md:h-3"
        })]
      }), variant === 'normal' ? /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx("button", {
        className: "w-6/12 h-5/6 min-w-max px-8 flex items-center  justify-center rounded-md bg-accent text-light font-normal transition-colors duration-200 focus:outline-none hover:bg-accent-hover focus:bg-accent-hover",
        ...
        children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx("span", {
          className: "sr-only",
          children: t('common:text-search')
        }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx(_components_icons_search_icon__WEBPACK_IMPORTED_MODULE_1__/* .SearchIcon */ .W, {
          className: "w-4 h-4"
        })]
      })]
    })
...
const GroupsMenu = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(react_.Menu, {
    as: "div",
    className: "relative block text-left w-7/12 border-e-2 border-accent",
    children: [/*#__PURE__*/jsx_runtime_.jsx(react_.Menu.Button, {
      className: external_classnames_default()('flex items-center flex-shrink-0 text-sm md:text-base font-semibold h-11 focus:outline-none text-heading xl:px-4', {
        'bg-gray-50 rounded-lg px-3 w-full': variant === 'minimal',
      ...
      children: /*#__PURE__*/jsx_runtime_.jsx(react_.Menu.Items, {
        as: "ul",
        className: external_classnames_default()('absolute  mt-2  py-2 w-full h-56 lg:h-auto min-h-40 max-h-56 sm:max-h-72 bg-light rounded shadow-700 focus:outline-none', {
