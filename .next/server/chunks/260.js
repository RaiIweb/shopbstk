...
/* harmony import */ var _components_ui_forms_input__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1860);
...
const schema = yup__WEBPACK_IMPORTED_MODULE_5__.object().shape({
  token: yup__WEBPACK_IMPORTED_MODULE_5__.string().required('error-password-required')
});
...
const EnterTokenView = ({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("form", {
    ...
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx(_components_ui_forms_input__WEBPACK_IMPORTED_MODULE_1__/* .default */ .Z, _objectSpread(_objectSpread({
      ...
      variant: "outline",
      className: "mb-5",
      error: t((_errors$token = errors.token) === null || _errors$token === void 0 ? void 0 : _errors$token.message)
      ...
      loading: loading,
      disabled: loading,
      children: t('text-submit-token')
    })]
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EnterTokenView);
